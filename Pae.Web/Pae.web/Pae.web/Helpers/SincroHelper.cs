...
namespace Pae.web.Helpers
{
    public class SincroHelper
    {
        ...
        {
            int registrossql = 0;
            SqlConnection conexionsql = new SqlConnection("Data Source=45.71.180.58,7745;Initial Catalog=Pae_dev;Persist Security Info=True;User ID=sa;Password=cafe123.;User Instance=False");
            conexionsql.Open();
